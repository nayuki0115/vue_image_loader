  ...
  <div class="image-wrapper" v-if="currentShow">
    <div class="image-content">
      ...
      <div class="image-tool">
        <span class="image-tool-button"><i class="fas fa-search-plus"></i></span>
        <span class="image-tool-button"><i class="fas fa-search-minus"></i></span>
        <span class="image-tool-button"><i class="fas fa-undo-alt"></i></span>
        <span class="image-tool-button"><i class="fas fa-redo-alt"></i></span>
      </div>
    </div>
  </div>
</template>
